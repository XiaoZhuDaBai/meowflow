...
public class ChatClientAli implements ChatClient {
    ...
    public ChatClientAli(String baseUrl, String apiKey, String model) {
    ...
    public ChatResponse chat(List<Message> messages, ChatOptions options) {
        ...
        try {
            ...
            throw new BizException(ResultCode.SERVICE_UNAVAILABLE, "阿里通义 API 调用失败");
        } catch (BizException e) {
            throw e;
        } catch (Exception e) {
            log.error("Ali chat error", e);
            throw new BizException(ResultCode.SERVICE_UNAVAILABLE, "阿里通义 API 调用异常: " + e.getMessage());
        }
    }
    ...
    public void streamChat(List<Message> messages, ChatOptions options, StreamCallback callback) {
        ...
        try {
            ...
            log.error("Ali stream chat error", e);
            callback.onError(e);
        }
    }
    ...
    public boolean isAvailable() {
        try {
            ...
            restTemplate.exchange(baseUrl + "/dashboard娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘娘", HttpMethod.GET, entity, Map.class);
            return true;
        } catch (Exception e) {
            log.warn("Ali service unavailable: {}", e.getMessage());
            return false;
        }
    }
    ...
    private ChatResponse parseResponse(Map body, long start) {
        ...
        String content = output != null ? (String) output.get("text") : "";
            ...
            if (line.startsWith("data: ")) {
                ...
                try {
                    ...
                    if (output != null && output.get("text") != null) {
                        String part = (String) output.get("text");
                        content.append(part);
                        callback.onChunk(part, index++);
                    }
                } catch (Exception e) {
                    log.debug("Parse Ali stream chunk error: {}", e.getMessage());
                }
            }
        }
